<#import "autodesk-common-lib-macros-1.ftl" as autodesk_macro>
<#-- OOTB components --
...
<#assign
	...
	currentURL = "https://forums${phase}.autodesk.com/t5/custom/page/page-id/BoardLandingPage"
/>
...
<#assign
	panelTabs = [
				...
				},
				{
					...
					"count"    : "autodesk_macro.getFrequentlyAskedQuestionsCount({'location':'boards','locationId':'\"${boardId}\"'})",
...

				{
					...
					"count"    : "autodesk_macro.getLastestSolutionsCount({'location':'boards','locationId':'\"${boardId}\"'})",
				...
				},
				{
					...
					"count"    : "autodesk_macro.getUnansweredPostsCount({'location':'boards','locationId':'\"${boardId}\"'})",
